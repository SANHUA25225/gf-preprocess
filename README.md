...
> 📖 **完整实战手册**：[MASTER_GUIDE.md](MASTER_GUIDE.md) —— 技能 × 仓库实战整合版（处理流程、GF-2 18 景实战、参数速查、踩坑 12 条、操作规范）。
> 🛰️ **GF-7 专项学习手册**：[GF7_处理学习手册.md](GF7_处理学习手册.md) —— 从波段认知到影像融合的端到端流程（波段系统/RPC/GCP/正射/重采样/融合）。
